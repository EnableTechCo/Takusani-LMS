...
| Audit events | 5-20 significant events per learner plus administrative events | 10,000-50,000 |
...
Combined source-object range is approximately 97 GB-2 TB/year before provider durability overhead. Five-year range: 0.5-10 TB. Seven-year range: 0.7-14 TB. Actual retention, compression, file limits, and lecture-recording policy dominate this estimate and require confirmation.
...
| Connection pool | Bound serverless connections | Wait time above 100 ms or saturation above 80% |
