export const MODULES = [
  ...
  { id: "programmes", label: "Programmes & cohorts", summary: "Programme structure, cohort lifecycle, enrolment, and moderation policy." },
  { id: "learning-content", label: "Learning content", summary: "Units, materials, sessions, attendance, and calendar feeds." },
  { id: "submissions", label: "Tasks & submissions", summary: "Tasks, upload intents, immutable versions, and receipts." },
  ...
  { id: "moderation", label: "Moderation", summary: "Scoped cycles, frozen populations, samples, holds, and sign-off." },
  ...
  { id: "department", label: "Department integration", summary: "Scoped credentials, records API, throttling, and access audit." },
